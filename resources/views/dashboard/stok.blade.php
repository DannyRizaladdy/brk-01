...
@section('content')
  ...
  <div class="main-content" id="panel">
    ...
    <div class="header bg-primary">
      <div class="container-fluid">
        <h2 class="h1 text-uppercase text-white pt-5">stok produk Berkah rindang kinasih</h2>
            ...
            <tbody class="list bg-white">
              @foreach($datas as $produk)
                <tr>
                    ...
                    <td>{{ $produk->umkm }}</td>
                    <td>
                        <form action="{{ url('stok/'.$produk->id) }}" method="post">
                          @csrf
                          <input type="hidden" value="DELETE" name="_method">
                          <input type="text" class="form-control" name="stok">
                          <button type="submit" class="btn btn-success mt-2">
                            <i class="fa fa-book mr-2"></i> TAMBAH STOK
                          </button>
                        </form>
                    </td>
                </tr>
