...
@section('content')
  ...
  <div class="main-content" id="panel">
    ...
    <nav class="navbar navbar-top navbar-expand navbar-dark bg-primary border-bottom">
      <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <!-- Search form -->
          <form class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main" method="get" action="{{ url('produk') }}">
            <div class="form-group mb-0">
              <div class="input-group input-group-alternative input-group-merge">
                <div class="input-group-prepend">
                  <span class="input-group-text"><i class="fas fa-search"></i></span>
                </div>
                <input class="form-control" placeholder="Pencarian" type="search" name="search">
              </div>
            </div>
    ...
    <div class="header bg-primary">
      <div class="container-fluid">
        <h2 class="h1 text-uppercase text-white pt-5">Data produk Berkah rindang kinasih</h2>
          ...
          <table class="table align-items-center table-flush">
            <thead class="thead-light">
              <tr>
                ...
                <th scope="col" class="sort">Terjual</th>
                <th scope="col" class="sort">Stok</th>
                <th scope="col" class="sort">Tanggal Stok</th>
            ...
            <tbody class="list bg-white">
              @foreach($datas as $index => $produk)
                <tr>
                    ...
                    <td>{{ $produk->stok }}</td>
                    <td>{{ $produk->tgl_stok }}</td>
                    <td>
                        <a href="{{ url('produk/'.$produk->id.'/edit') }}" class="btn btn-success pr-4"><i class="fa fa-book mr-2"></i> Edit</a> <br>
